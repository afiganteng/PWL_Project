...
class ServisMotorController extends Controller
{
    ...
    {	
        ...
        return view('servismotor.index' , compact('servis_motor'))
    ...
    public function create()
    {
        ...
        return view('servismotor.create',  ['Pelanggan' => $pelanggan, 'Mekanik' => $mekanik, 'Sparepart' => $sparepart]);
    }
    ...
    public function show($id)
    {
        ...
        $sparepart = Sparepart::all();
        $pelanggan = Pelanggan::all();
        return view('servismotor.detail', ['Pelanggan' => $pelanggan, 'ServisMotor' => $servis_motor,'Mekanik' => $mekanik, 'Sparepart' => $sparepart]);
    }
