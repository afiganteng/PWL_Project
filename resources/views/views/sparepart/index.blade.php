                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-info" href="{{ route('sparepart.show', $Sparepart->id_sparepart ) }}">Show</a>
                                    <a class="btn btn-primary" href="{{ route('sparepart.edit', $Sparepart->id_sparepart ) }}">Edit</a>
                                        @csrf
                                        @method('DELETE')
